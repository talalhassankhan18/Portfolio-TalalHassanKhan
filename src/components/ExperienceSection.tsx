  ...
  const experiences = [
    {
      ...
      description:
        "Currently working as a UI/UX Designer at Quipsol, focusing on creating responsive and user-friendly website interfaces. Collaborating with cross-functional teams to deliver visually appealing and functional designs that align with client requirements and enhance user experience.",
      responsibilities: [
        "Designed responsive and user-friendly website interfaces",
        "Created wireframes, mockups, and prototypes using Figma",
        "Collaborated with developers to ensure accurate design implementation",
        "Maintained brand consistency and visual aesthetics across all pages",
        "Refined designs based on client feedback and usability testing",
      ],
      technologies: [
        "UI/UX",
        "Figma",
    ...
    },
    {
      ...
      description:
        "Embarked on an exciting journey in UI/UX design, where I honed my skills in crafting user-centered interfaces. I collaborated with cross-functional teams to design intuitive layouts and enhance user satisfaction through iterative feedback and prototyping.",
      responsibilities: [
    ...
    },
    {
      ...
      location: "Pakistan - Remote",
      description:
        "Worked as a video editor for a Chicken Recipes YouTube channel, enhancing content quality through creative editing and post-production techniques to engage a growing audience.",
      responsibilities: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
            ...
            developer to leading complex projects and mentoring teams.
          </p>
        </div>
                  ...
                  <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white hover:scale-105">
                    <CardHeader>
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                        ...
                        <Badge
                          variant="outline"
                          className="w-fit text-xs text-primary border-primary"
                        >
                          {exp.duration}
                        </Badge>
                      </div>
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1">
                          {exp.responsibilities.map((responsibility, idx) => (
                            <li
                              key={idx}
                              className="text-sm text-base-content/70 flex items-start"
                            >
                              <span className="text-primary mr-2 mt-1.5">
                                •
                              </span>
                              {responsibility}
                            </li>
